#!/usr/bin/env python3
"""Scaffolds the 18 plugins added in add-nexion-inspired-plugins.py: a
compiling project (csproj, .addin, Application.cs) for each. Command.cs is
written by hand afterward for the 12 that ship live this pass; the other 6
get a placeholder like the earlier in-development scaffolds."""
import json
import os
import re
import uuid
...
NEW_SLUGS = {
    "legendplacer", "autolegendbuilder", "overridebyparam", "highlightwalls",
    "selectbycategory", "viewmatrix", "parameterformulapropagator",
    "scheduleblankdetector", "excelasdraft", "roominventory",
    "roomfinishschedule", "modelceilings", "uniquenumbering", "plansperroom",
    "autoheights", "roomclearheight", "pointcloudcolors", "pointcloudheatmap",
}
...
guid_path = os.path.join(os.path.dirname(__file__), "nexion_wave_guids.json")
