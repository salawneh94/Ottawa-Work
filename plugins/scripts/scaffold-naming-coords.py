#!/usr/bin/env python3
"""Scaffolds NamingConventionAudit and SharedCoordinatesAudit: a compiling
project (csproj, .addin, Application.cs) for each. Command.cs is written by
hand afterward, both ship live."""
import json
import os
import re
import uuid
...
NEW_SLUGS = {"namingconventionaudit", "sharedcoordinatesaudit"}
...
guid_path = os.path.join(os.path.dirname(__file__), "naming_coords_guids.json")
