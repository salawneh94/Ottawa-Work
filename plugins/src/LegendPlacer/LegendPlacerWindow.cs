...
public class LegendPlacerWindow : OttawaWorkWindow
{
    ...
    private readonly TextBox _xBox = OttawaWorkUi.TextBox();
    private readonly TextBox _yBox = OttawaWorkUi.TextBox();
    ...
    public LegendPlacerWindow(List<View> legends, List<ViewSheet> sheets) : base("Ottawa Tools — LegendPlacer", minWidth: 420)
    {
        _legends = legends;
        _xBox.Text = "0.6";
        _yBox.Text = "0.6";
        ...
        root.Children.Add(OttawaWorkUi.TitleBar("🗂️", "Legend Placer", "Batch-place one legend view onto many sheets at the same position."));
        ...
        xStack.Children.Add(OttawaWorkUi.FieldLabel("Position X (m)"));
        _xBox.Width = 100;
        xStack.Children.Add(_xBox);
        var yStack = new StackPanel();
        yStack.Children.Add(OttawaWorkUi.FieldLabel("Position Y (m)"));
        _yBox.Width = 100;
        ...
        sheetsStack.Children.Add(OttawaWorkUi.SectionHeader("Target sheets"));
